...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Brother Eye - Real-Time Global Intelligence Dashboard',
    ...
    url: 'https://brother-eye-phi.vercel.app/',
    siteName: 'Brother Eye',
  ...
  tech: {
    ...
    url: 'https://brother-eye-phi.vercel.app/?variant=tech',
    siteName: 'Brother Eye Tech',
  ...
  finance: {
    ...
    url: 'https://brother-eye-phi.vercel.app/?variant=finance',
    siteName: 'Brother Eye Finance',
  ...
  commodity: {
    ...
    url: 'https://brother-eye-phi.vercel.app/?variant=commodity',
    siteName: 'Brother Eye Commodity',
