...
async function sendConfirmationEmail(email, referralCode) {
  ...
  const shareText = encodeURIComponent('I just joined the Brother Eye Pro waitlist \u2014 real-time global intelligence powered by AI. Join me:');
  ...
  const telegramShare = `https://t.me/share/url?url=${shareUrl}&text=${encodeURIComponent('Join the Brother Eye Pro waitlist:')}`;
  ...
  try {
    const resendRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'Brother Eye <noreply@worldmonitor.app>',
        to: [email],
        subject: 'You\u2019re on the Brother Eye Pro waitlist',
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #e0e0e0;">
            ...
            <div style="border-top: 1px solid #1a1a1a; padding: 24px 32px; text-align: center;">
              ...
              <p style="font-size: 11px; color: #444; margin: 0; line-height: 1.6;">
                Brother Eye \u2014 Real-time intelligence for a connected world.<br />
