...
const Logo = () => (
  <a href="https://worldmonitor.app" className="flex items-center gap-2 hover:opacity-80 transition-opacity" aria-label="Brother Eye — Home">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <div className="flex items-baseline gap-2 mb-1">
                <span className="font-bold text-gray-200">Brother Eye</span>
...
const Footer = () => (
  <footer className="border-t border-wm-border bg-[#020202] pt-24 pb-12 px-6 text-center" id="waitlist">
    ...
    <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto pt-8 border-t border-wm-border/50 text-xs text-wm-muted font-mono">
      ...
      <div className="flex gap-6">
        <a href="https://x.com/worldmonitorai" target="_blank" rel="noreferrer" aria-label="Follow Brother Eye on X" className="hover:text-wm-text transition-colors">X</a>
        <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noreferrer" aria-label="Brother Eye on GitHub" className="hover:text-wm-text transition-colors">GitHub</a>
        <a href="https://www.wired.me/story/the-music-streaming-ceo-who-built-a-global-war-map" target="_blank" rel="noreferrer" aria-label="Read the WIRED article about Brother Eye" className="hover:text-wm-text transition-colors">{t('footer.wiredArticle')}</a>
      </div>
    </div>
  </footer>
);
